...
class SharedAdam(optim.Adam):
    def __init__(self, params, lr=.0001, betas=(0.9, 0.999), eps=1e-8,
                 weight_decay=0):
...
class SharedRMSprop(optim.RMSprop):
    def __init__(self, params, lr=7e-4, alpha=0.99, eps=1e-8, weight_decay=0, momentum=0, centered=False):
